...
def sat_allowed_group_assignment_entry():
    """sat_allowed_group_assignment_entry is the entry function to solve a combinational problem with optimal object and linear constraints
...
if __name__ == "__main__":
    sat_allowed_group_assignment_entry()