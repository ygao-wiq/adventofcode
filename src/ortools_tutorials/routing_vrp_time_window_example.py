...
def print_solution_from_array(routes, cumul_data):
  """Print the solution."""
  total_time = 0
  route_str = ''
...
def routing_time_window_entry():
    """routing_time_window_entry is the entry function to solve the VRP with time windows."""
