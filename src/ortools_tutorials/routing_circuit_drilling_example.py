...
def routing_circuit_drilling_entry():
    """routing_circuit_drilling_entry is the entry point of the program.

    It is to find a shortest route for a drill to create all required holes before getting back to the starting point
    """
...
if __name__ == "__main__":
    routing_circuit_drilling_entry()