...
def routing_resource_constraint_entry():
    """routing_resource_constraint_entry is the entry function to solve the VRP with time windows."""
...
if __name__ == "__main__":
    routing_resource_constraint_entry()